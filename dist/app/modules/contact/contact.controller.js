...
const createAContact = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield contact_service_1.contactService.createAContact(req.body);
...
const getAllContact = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield contact_service_1.contactService.getAllContacts(filters, options);
    (0, sendResponse_1.default)(res, {
